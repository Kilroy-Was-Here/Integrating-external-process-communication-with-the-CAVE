...
files = glob.glob("quarter resolution\\*.png")
...
earthCloudsTexture = viz.addTexture('just-clouds.png')
...
def updateClouds():
    ...
    earthCloudsTexture = viz.addTexture(files[counter])
    earthClouds.texture(earthCloudsTexture)
    earthCloudsTexture.wrap(viz.WRAP_S,viz.REPEAT)
...
vizact.ontimer(0.25,updateClouds)